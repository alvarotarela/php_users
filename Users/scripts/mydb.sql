...
INSERT INTO `cities` VALUES (1,'Wigo'),(2,'Santiago'),(3,'A Coruña'),(4,'Ferrol'),(5,'Ferrol'),(6,'Ferrol'),(7,'Ferrol'),(8,'Ferrol'),(9,'Ferrol'),(10,'Ferrol');
...
CREATE TABLE `pets` (
  ...
  `name` varchar(45) NOT NULL COMMENT 'Name of the pet',
  PRIMARY KEY (`idpets`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `users` (
  ...
  `genders_idgender` int(11) DEFAULT NULL,
  `cities_idcity` int(11) DEFAULT NULL,
...
INSERT INTO `users` VALUES (1,'agustincl','agustincl@gmail.com','1234','Agustin',NULL,NULL,NULL,NULL,'2014-02-19 17:45:16',NULL,NULL,NULL,NULL);
...
-- Dump completed on 2014-02-19 20:09:22
