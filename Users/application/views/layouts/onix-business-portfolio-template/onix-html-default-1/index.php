...
<div class="container">
	<?php include($_SERVER['DOCUMENT_ROOT'].'/partials/container.html');?>
	<?php //include($_SERVER['DOCUMENT_ROOT'].'/partials/usuarios.php');?>
 </div>
<!-- Footer
================================================== -->
...
<?php include($_SERVER['DOCUMENT_ROOT'].'/partials/js.html');?>
  </body>
</html>
